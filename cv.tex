...
\begin{innerlist}
    ...
    \item[$-$] Publications: 2 under review.
    \item[$-$] Patents: 3 filed. 5 defensive patent publications.
		%\item[$-$] 2 publications.
  \end{innerlist}
  ...
  \halfblankline
    ...
    \item[$-$] Patents: 2 filed. 3 defensive patent publications. %\cite{Tran2018a} (pending), \cite{Tran2018b} (pending).
...
\item Bachelor of Computer Science, with First Class Honours. \hfill{2006 -- 2009}
	\begin{innerlist}
...
%
\begin{innerlist}
	\item Experienced: Scikit-learn, Anaconda, pandas, numpy, dplyr/tidyverse, JQuery, Flask, MySQL, Eclipse, PDFBox, GitHub, ZenHub, IBM Cloud, LaTeX, Word, Excel, Powerpoint, Ubuntu Linux, Windows, macOS.
	\item Familiar: Tensorflow, Docker, Kubernetes, NLTK, Stanford NLP, Watson Assistant (chatbot).
\end{innerlist}
...
Metrics from Google Scholar (Mar 20): 279 citations, h-index: 8, i10-index: 7.
