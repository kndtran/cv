...
\begin{innerlist}
    ...
    \item[$-$] Led a client project on prediction of human effort in asset creation for business processes. Features end-to-end machine learning pipelines with a graph representational model using structured data, and focusing on paralellism and extensibility in hyper-parameter search.
  ...
  \halfblankline
	...
	\begin{innerlist}
		%\item[$-$] Manager: Dr. Christopher J. Butler.
    \item[$-$] Developed document chunking solutions and classification models for IBM Global Process Services (for Watson Education). Research work recognized as division led expertise and is one of the core features of an IBM offer (C3 -- http://microsite-us.mybluemix.net/).
...
\begin{innerlist}
	...
	\begin{innerlist}
		...
		\item[$-$] Developed code from analysts' observations and business knowledge, and producing data visualizations and automated on-demand reports in production environments.
    \end{innerlist}
\end{innerlist}
...
\begin{innerlist}
	...
	\begin{innerlist}
		...
		%\item[$-$] 3 publications. One for each project.
	\end{innerlist}
...
%
\begin{innerlist}
	\item Experienced: Scikit-learn, Anonconda, pandas, numpy, dplyr/tidyverse, JQuery, Flask, MySQL, Eclipse, PDFBox, GitHub, ZenHub, IBM Cloud, LaTeX, Word, Excel, Powerpoint, Ubuntu Linux, Windows, macOS.
	\item Familiar: Tensorflow, Docker, Kubernetes, NLTK, Stanford NLP, Watson Assistant, Watson Studio.
\end{innerlist}
...
%\item Mentor, Data Science and Machine Learning, 2017-2018.
%\begin{innerlist}
%\item[$-$] 2017: 3 Masters student and 1 industry professional.
%\item[$-$] 2017: 1 Masters student and 2 industry professionals.
%\end{innerlist}
...
\begin{comment}
\textbf{Simon Wail} (email: simon.wail@au1.ibm.com)
%
\begin{innerlist}
	\item IBM Research Australia
...
\textbf{Mukesh~Mohania} (email: mukeshm@au1.ibm.com)
%
\begin{innerlist}
	\item IBM Research Australia
	\item 60 City Road, Southbank, VIC 3006, Australia
	\item \emph{He is my mentor for research.}
\end{innerlist}
...
\textbf{Jey~Han~Lau} (email: jeyhan.lau@au1.ibm.com)
%
\begin{innerlist}
	\item IBM Research Australia
	\item 60 City Road, Southbank, VIC 3006, Australia
	\item \emph{He is a research colleague in my team.}
\end{innerlist}
...
\textbf{Chris~Butler} (email: chris.butler@au1.ibm.com)
%
\begin{innerlist}
	\item IBM Research Australia
	\item 60 City Road, Southbank, VIC 3006, Australia
	\item \emph{He was my manager. He is on appointment in the US.}
\end{innerlist}
\end{comment}
...
As of Jan 31: 275 citations, h-index: 8, i10-index: 8.

\halfblankline

%ResearchGate profile: \url{https://www.researchgate.net/profile/Khoi\_Nguyen\_Tran}
