...
%
\begin{innerlist}
	\item Experienced: Scikit-learn, pandas, numpy, dplyr/tidyverse, Spark, JQuery, Flask, MySQL, Eclipse, PDFBox, GitHub, ZenHub, IBM Cloud, LaTeX, Word, Excel, Powerpoint, Ubuntu Linux, Windows, macOS.
