...
\begin{innerlist}
	...
	\begin{innerlist}
		...
		\item[$-$] Developed code from analysts' observations and business knowledge, producing data visualizations and automated on-demand reports in production environments.
    \end{innerlist}
\end{innerlist}
