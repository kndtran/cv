...
\begin{innerlist}
  ...
  \halfblankline
    ...
    \item[$-$] Patents: 2 pending. %\cite{Tran2018a} (pending), \cite{Tran2018b} (pending).
...
\item Ph.D. in Engineering and Computer Science. \hfill{Feb 2010 -- Jul 2015}
	\begin{innerlist}
		...
		\item[$-$] Supervisors: Prof. Peter Christen, Dr. Scott Sanner, Dr. Lexing Xie.
		\item[$-$] Publications: \cite{Tran2013}, \cite{Tran2013a}, \cite{Tran2015a}, \cite{Tran2015}, \cite{Tran2015b}.
		%\item[$-$] 5 publications.
	\end{innerlist}
...
%
\begin{innerlist}
	\item Experienced: Scikit-learn, JQuery, Flask, MySQL, dplyr / tidyverse, numpy, pandas, Anaconda, Eclipse, PDFBox, GitHub, ZenHub, IBM Cloud, LaTeX, Word/Excel/Powerpoint, Ubuntu Linux, Windows, macOS.
...
\begin{innerlist}
	\item IBM Research -- Australia
	\item 60 City Road, Southbank, VIC 3006, Australia
	\item \emph{He is my mentor for research and patents.}
\end{innerlist}
