...
\begin{outerlist}
	...
	\begin{innerlist}
		\item[$-$] Developing research solutions to understanding of PDF documents for the Watson Education business unit.
...
\begin{outerlist}
	...
	\begin{innerlist}
		\item[$-$] Led development of advanced profiling techniques in collaboration with experienced data analysts.
		\item[$-$] Revised production profiling scripts for correctness and reimplementation into a new production system.
		\item[$-$] Led the creation of a report into data quality of internal production databases.
      \end{innerlist}
\end{outerlist}
...
\begin{outerlist}
	...
	\begin{innerlist}
		...
		\item[$-$] Led an ethics proposal for a research project on people's susceptibility to cybercrime.
