...
\begin{outerlist}
	\item Postdoctoral Researcher. Full-time. Cognitive Analytics Team. \hfill {2016 -- Current}
	\begin{innerlist}
		\item[$-$] Applying research methods and developing software for Watson Education.
		\item[$-$] Developing research techniques and applications in the fields of text mining, progressing to natural language processing and deep learning.
  \end{innerlist}
\end{outerlist}
...
\begin{outerlist}
	\item Data Scientist. Full-time. Research Team. \hfill {2015 -- 2016}
	\begin{innerlist}
		\item[$-$] Developed various data extraction software based on agile principles. Primarily focused on bridging the gap between the DBMS and analysts from within my team and other teams.
		\item[$-$] Investigated, applied, and developed generalisable research techniques on text mining, natural language processing, and data quality.
  \end{innerlist}
\end{outerlist}
